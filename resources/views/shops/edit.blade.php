...
<div class="row">
 <div class="col-md-8 order-md-1">
    <h4 class="mb-3">Ažurirajte podatke o Vašemu obrtu</h4>
    <form class="needs-validation" novalidate action="{{route('shops.update', $shop->id)}}" method="post">
    @csrf
    @method('PUT')

    <div class="mb-3">
        <label for="name">Naziv obrta</label>
        <input type="text" name="name" value="{{ $shop->name }}" class="form-control" id="name" placeholder="" required>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="phone" value="{{ $shop->phone }}" class="form-control" id="phone" placeholder="+385 ** *** ****" required>
        <div class="invalid-feedback">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="address" value="{{ $shop->address }}" class="form-control" id="address" placeholder="Vukovarska ulica 58" required>
        <div class="invalid-feedback">
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          ...
          <select class="custom-select d-block w-100" name="county" id="county" required>
            <option value="{{$shop->county}}" selected>{{$shop->county}}</option>
        ...
        <div class="col-md-3 mb-3">
          ...
          <input type="text" class="form-control" name="postcode" value="{{ $shop->postcode }}" id="postcode" placeholder="51 000" required>
          <div class="invalid-feedback">
        ...
        <div class="col-md-5 mb-3">
            ...
            <input type="text" class="form-control" name="city" value="{{ $shop->city }}" id="city" placeholder="Rijeka" required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-5 mb-3">
            ...
            <textarea class="form-control" name="description" id="" rows="3">{{ $shop->description }}</textarea>
        </div>
      </div>
      <hr class="mb-4">


      <button class="btn btn-primary btn-lg btn-block" type="submit">Potvrdi</button>
    </form>
  </div>
