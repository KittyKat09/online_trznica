    ...
    <div class="mb-3">
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
            ...
            <input type="number" required class="form-control" name="price" id="" min="0" step="0.01" aria-describedby="helpId" placeholder="">
            <div class="invalid-feedback">
              Molimo Vas, ispunite ovo polje.
            </div>
        </div>
        <div class="col-md-4 mb-3">
            ...
            <select class="custom-select d-block w-100" name="unit" id="unit" required>
              ...
              <option value="kom">komadu</option>
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="number" required class="form-control" name="quantity" id="" min="0" step="1" aria-describedby="helpId" placeholder="">
            <div class="invalid-feedback">
              Molimo Vas, ispunite ovo polje.
            </div>
        </div>
      ...
      <button class="btn btn-primary btn-lg btn-block" type="submit">Potvrdi podatke</button>
    </form>
</div>
